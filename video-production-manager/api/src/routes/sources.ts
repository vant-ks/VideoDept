...
router.post('/', async (req: Request, res: Response) => {
  ...
  try {
    ...
    console.log('✅ Source inserted successfully with uuid:', createdUuid);
    ...
    console.log('🔍 Fetching created using uuid for reliability');
    console.log('🔍 Fetching created source with uuid:', createdUuid);
