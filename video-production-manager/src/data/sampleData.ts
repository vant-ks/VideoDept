...
export const sampleChecklist: ChecklistItem[] = [
  { id: 'chk-1', title: 'Screen Parameters', category: 'PRE_PRODUCTION', item: 'Screen Parameters', daysBeforeShow: 60, completed: false },
  { id: 'chk-2', title: 'Screen Obstructions', category: 'PRE_PRODUCTION', item: 'Screen Obstructions', daysBeforeShow: 45, completed: false },
  { id: 'chk-3', title: 'Staging requirements', category: 'PRE_PRODUCTION', item: 'Staging requirements', daysBeforeShow: 45, completed: false },
  { id: 'chk-4', title: 'Rigging requirements', category: 'PRE_PRODUCTION', item: 'Rigging requirements', daysBeforeShow: 45, completed: false },
  { id: 'chk-5', title: 'Power requirements', category: 'PRE_PRODUCTION', item: 'Power requirements', daysBeforeShow: 30, completed: false },
  { id: 'chk-6', title: 'Build Schedule', category: 'PRE_PRODUCTION', item: 'Build Schedule', daysBeforeShow: 14, completed: false },
  { id: 'chk-7', title: 'Build Special Notes', category: 'PRE_PRODUCTION', item: 'Build Special Notes', daysBeforeShow: 14, completed: false },
  { id: 'chk-8', title: 'Tile, Projector, Lens, and Lumen Counts', category: 'PRE_PRODUCTION', item: 'Tile, Projector, Lens, and Lumen Counts', daysBeforeShow: 60, completed: false },
  { id: 'chk-9', title: 'Projection Mapping', category: 'PRE_PRODUCTION', item: 'Projection Mapping', daysBeforeShow: 30, completed: false },
  { id: 'chk-10', title: 'Vendor initial list + contact', category: 'SCREENS', item: 'Vendor initial list + contact', completed: false },
  { id: 'chk-11', title: 'SUB - Vendor initial contact', category: 'SCREENS', item: 'SUB - Vendor initial contact', completed: false },
  { id: 'chk-12', title: 'SUB - Review quote', category: 'SCREENS', item: 'SUB - Review quote', completed: false },
  { id: 'chk-13', title: 'SUB - Last changes due', category: 'SCREENS', item: 'SUB - Last changes due', completed: false },
  { id: 'chk-14', title: 'SUB - Quote approval', category: 'SCREENS', item: 'SUB - Quote approval', completed: false },
  { id: 'chk-15', title: 'Verify transfer method', category: 'SCREENS', item: 'Verify transfer method', completed: false },
  { id: 'chk-16', title: 'Verify delivery address', category: 'SCREENS', item: 'Verify delivery address', completed: false },
  { id: 'chk-17', title: 'Verify delivery dates', category: 'SCREENS', item: 'Verify delivery dates', completed: false },
  { id: 'chk-18', title: 'Verify delivery times', category: 'SCREENS', item: 'Verify delivery times', completed: false },
  { id: 'chk-19', title: 'Input counts', category: 'SWITCH', item: 'Input counts', daysBeforeShow: 30, completed: false },
  { id: 'chk-20', title: 'Output counts', category: 'SWITCH', item: 'Output counts', daysBeforeShow: 30, completed: false },
  { id: 'chk-21', title: 'Layer requirements', category: 'SWITCH', item: 'Layer requirements', daysBeforeShow: 30, completed: false },
  { id: 'chk-22', title: 'Router requirements', category: 'SWITCH', item: 'Router requirements', daysBeforeShow: 30, completed: false },
  { id: 'chk-23', title: 'Switcher options', category: 'IMAG', item: 'Switcher options', daysBeforeShow: 60, completed: false },
  { id: 'chk-24', title: 'Camera options', category: 'IMAG', item: 'Camera options', daysBeforeShow: 60, completed: false },
  { id: 'chk-25', title: 'Camera counts', category: 'IMAG', item: 'Camera counts', daysBeforeShow: 60, completed: false },
  { id: 'chk-26', title: 'PTZ counts', category: 'IMAG', item: 'PTZ counts', daysBeforeShow: 60, completed: false },
  { id: 'chk-27', title: 'Illustrator Design Template', category: 'MEDIA_SERVERS', item: 'Illustrator Design Template', daysBeforeShow: 60, completed: false },
  { id: 'chk-28', title: 'AE Design Template', category: 'MEDIA_SERVERS', item: 'AE Design Template', daysBeforeShow: 60, completed: false },
  { id: 'chk-29', title: 'AME Presets', category: 'MEDIA_SERVERS', item: 'AME Presets', daysBeforeShow: 60, completed: false },
  { id: 'chk-30', title: 'Media Server Project [CLOUD]', category: 'MEDIA_SERVERS', item: 'Media Server Project [CLOUD]', daysBeforeShow: 30, completed: false },
  { id: 'chk-31', title: 'Media Server Project [ONSITE]', category: 'MEDIA_SERVERS', item: 'Media Server Project [ONSITE]', daysBeforeShow: 7, completed: false },
  { id: 'chk-32', title: 'Server Allocation Plan', category: 'MEDIA_SERVERS', item: 'Server Allocation Plan', daysBeforeShow: 30, completed: false },
  { id: 'chk-33', title: 'Backstage Layout', category: 'DOCUMENTATION', item: 'Backstage Layout', daysBeforeShow: 45, completed: false },
  { id: 'chk-34', title: 'Load In Plan', category: 'DOCUMENTATION', item: 'Load In Plan', daysBeforeShow: 45, completed: false },
  { id: 'chk-35', title: 'Cable Path', category: 'DOCUMENTATION', item: 'Cable Path', daysBeforeShow: 30, completed: false },
  { id: 'chk-36', title: 'Budget Review', category: 'DOCUMENTATION', item: 'Budget Review', daysBeforeShow: 60, completed: false },
  { id: 'chk-37', title: 'Tile Maps', category: 'DOCUMENTATION', item: 'Tile Maps', daysBeforeShow: 45, completed: false },
  { id: 'chk-38', title: 'Video Production Info', category: 'DOCUMENTATION', item: 'Video Production Info', daysBeforeShow: 30, completed: false },
  { id: 'chk-39', title: 'Wiring Diagram', category: 'DOCUMENTATION', item: 'Wiring Diagram', daysBeforeShow: 30, completed: false },
  { id: 'chk-40', title: 'Equipment List', category: 'DOCUMENTATION', item: 'Equipment List', daysBeforeShow: 60, completed: false },
];
